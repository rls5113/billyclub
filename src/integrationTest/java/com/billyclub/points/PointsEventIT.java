...
//    int randomServerPort;
    ...
    public void getPointsEvents_returnsAllPointEvents() throws Exception {
        ResponseEntity<CollectionModel<EntityModel<PointsEvent>>> response = restTemplate.exchange("/api/v1/pointsEvents", HttpMethod.GET, null, new ParameterizedTypeReference<CollectionModel<EntityModel<PointsEvent>>>() {
        });

        CollectionModel<EntityModel<PointsEvent>> list = response.getBody();
